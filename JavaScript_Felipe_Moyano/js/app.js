var Calculadora = {
	...
	viewnum: function(valor){
		...
		if(this.pantalla.length < this.maxDig){
			if(this.pantalla != "0"){
				this.pantalla += valor;
			}else if(valor != 0){
				this.pantalla = "",
	...
	viewdisplay: function(){
		if(this.pantalla.toString().length > this.maxDig){
